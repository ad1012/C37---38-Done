...
function setup() {
  ...
  trex = createSprite(800/2 -300, 600/2-90,20,50);
  trex.addAnimation("running", trex_running);
  trex.addAnimation("collided",trex_collided);  
  trex.scale = 0.5;
  
  ground = createSprite(800/2,600/2-100,800,20);
  ...
  invisibleGround = createSprite(800/2,600/2-80,displayWidth,10);
...
function spawnClouds() {
  ...
  if (camera.position.x % 60 === 0) {    
    var cloud = createSprite(displayWidth,displayHeight/2 - 100 ,40,10);
    cloud.y = Math.round(random(80,displayHeight/2 - 300));
...
function spawnObstacles() {
  if(camera.position.x % 60 === 0) {
    var obstacle = createSprite(displayWidth,displayHeight/5,15,50);    
